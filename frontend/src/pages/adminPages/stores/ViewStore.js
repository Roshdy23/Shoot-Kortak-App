        ...
        <>
            <div className="container mt-5">
                ...
                <div className="row">
                    ...
                    <Link className="btn btn-success col col-lg-2" to={`/stores/` + { viewstorename } + `/additem`}>Add Items</Link>
                </div>
                <div className="row">
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th scope="col">400</th>
                                    <th scope="col">0%</th>
                                    <td><Link class="btn btn-info" to={`/stores/` + { viewstorename } + `/update`}>Update</Link></td>
                                </tr>
                                <tr>
